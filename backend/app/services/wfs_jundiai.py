...
def carregar_camadas(grupo: str, combinar: bool = True):
    ...
    #url_wfs = 'https://geoinfo.dados.embrapa.br/geoserver/ows?service=wfs&version=2.0.0&request=GetCapabilities'
    camadas = GRUPOS_CAMADAS[grupo]
    #camadas = 'geonode:car2022_municipios2019_dimensaopatrimonio_valorha2020_wgs84utf'
    ...
    for camada in camadas:
        ...
        print(f'Camada carregada: {camada}')
    ...
    # Dissolver se necessário
    if combinar and not gdf_combinado.empty:
        try:
...
def carregar_areas_verdes():
    ...
    return carregar_camadas("zoneamento")
    # return carregar_camadas('valor_patrimonio_ha')